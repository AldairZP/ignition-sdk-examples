...
type ToastType = "success" | "info" | "warning" | "error" | "show";
type ToastPosition =
  | "top-left"
  | "top-center"
  | "top-right"
...
export const ToastSileoControls = () => {
  ...
  const [description, setDescription] = useState("No se pudo inicializar Sileo");
  ...
  return (
    <>
      <div>
        <label>
          Type
          <select value={type} onChange={(event) => setType(event.target.value as ToastType)}>
